...
export const PetForm = () => {
    const { initialValues, validationSchema, onSubmit } = usePetForm();
    const { species, fetchAllSpecies, loading } = useSpecieStore();

    const { control, handleSubmit, formState: { errors } } = useForm<Omit<IPet, 'ownerId'>>({
        ...
        <Box className="w-full max-w-md mx-auto">
            <VStack space="md">
                ...
                <VStack space="xs">
                    ...
                    />
                    {errors.birthDate && (
                        <Text className="text-red-500 text-xs">{errors.birthDate.message}</Text>
                    )}
                </VStack>
                ...
                <VStack space="xs">
                    ...
                    />
                    {errors.specieId && (
                        <Text className="text-red-500 text-xs">{errors.specieId.message}</Text>
                    )}
                </VStack>
